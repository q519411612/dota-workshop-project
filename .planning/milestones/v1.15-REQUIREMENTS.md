# Requirements Archive: v1.15 Verifiable Release Candidate Export and Handoff

**Archived:** 2026-07-29
**Status:** SHIPPED

No active requirements file remains after archival. Start the next milestone with `$gsd-new-milestone` to define a fresh requirement slice.
