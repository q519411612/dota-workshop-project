...
| VERI-03 | passed | Typecheck, 388-test suite, build, plugin, same-machine harness, snapshot, install, RC, handoff, milestone, examples, docs, and packaged runtime pass. |
