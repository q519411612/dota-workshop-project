...
async function writeAddon(paths, addonName, mapName, template) {
...
export function renderAddonFiles(addonName, mapName, template = "playable") {
    return {
...
function playableLuaEntry(addonName) {
