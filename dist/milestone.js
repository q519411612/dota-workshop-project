...
export async function verifyMilestoneCloseout(input = {}) {
...
async function buildDocumentationItems(root, handoffResult, blockers) {
...
async function coverageItem(root, relPath, label, requiredTerms, blockers, messageLabel = label) {
    let content = "";
    try {
...
function handoffReportItem(handoffResult, blockers) {
    const evidence = [];
...
function copyHandoffBlocker(blocker, root) {
    return {
        code: blocker.code,
